...
``pysyncrosim`` was tested and developed using **Python 3.12** and **SyncroSim 3.0.9**. Because ``pysyncrosim`` uses ``rasterio`` for integrating spatial data, it also requires a C library dependency: ``GDAL >=3.7``.
